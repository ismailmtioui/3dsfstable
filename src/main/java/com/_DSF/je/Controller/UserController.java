...
public class UserController {
    ...
    @GetMapping("/searchByNameAndRole")
    public List<User> searchUsersByNameAndRole(@RequestParam("username") String username, @RequestParam("role") Role role) {
        return userService.searchUsersByUsernameAndRole(username,role);
    }
}
